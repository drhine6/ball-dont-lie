  ...
  const bettingData: BettingDataType = {
    South: [
      { 
        ...
        type: 'Favorite', 
        confidence: 'High',
        team1: { name: 'Auburn', logoId: teamLogoIds['Auburn'], seed: 1, brand: 'Wilson' },
        team2: { name: 'First Four Winner', logoId: teamLogoIds['First Four Winner'], seed: 16, brand: 'TBD' }
      },
      { 
        ...
        type: 'Total Bet', 
        confidence: 'High',
        team1: { name: 'Louisville', logoId: teamLogoIds['Louisville'], seed: 8, brand: 'Adidas' },
        team2: { name: 'Creighton', logoId: teamLogoIds['Creighton'], seed: 9, brand: 'Nike' }
      },
      { 
        ...
        type: 'Upset Alert', 
        confidence: 'High',
        team1: { name: 'Michigan', logoId: teamLogoIds['Michigan'], seed: 5, brand: 'Nike' },
        team2: { name: 'UC San Diego', logoId: teamLogoIds['UC San Diego'], seed: 12, brand: 'Wilson' }
      },
      { 
        ...
        type: 'Favorite', 
        confidence: 'High',
        team1: { name: 'Texas A&M', logoId: teamLogoIds['Texas A&M'], seed: 4, brand: 'Wilson' },
        team2: { name: 'Yale', logoId: teamLogoIds['Yale'], seed: 13, brand: 'Spalding' }
      },
      { 
        ...
        type: 'Total Bet', 
        confidence: 'Medium',
        team1: { name: 'Ole Miss', logoId: teamLogoIds['Ole Miss'], seed: 6, brand: 'Nike' },
        team2: { name: 'SDSU/UNC', logoId: teamLogoIds['SDSU/UNC'], seed: 11, brand: 'TBD' }
      },
      { 
        ...
        type: 'Upset Alert', 
        confidence: 'High',
        team1: { name: 'Iowa State', logoId: teamLogoIds['Iowa State'], seed: 3, brand: 'Nike' },
        team2: { name: 'Lipscomb', logoId: teamLogoIds['Lipscomb'], seed: 14, brand: 'Wilson' }
      },
      { 
        ...
        type: 'Total Bet', 
        confidence: 'High',
        team1: { name: 'Marquette', logoId: teamLogoIds['Marquette'], seed: 7, brand: 'Nike' },
        team2: { name: 'New Mexico', logoId: teamLogoIds['New Mexico'], seed: 10, brand: 'Nike' }
      },
      { 
        ...
        type: 'Upset Alert', 
        confidence: 'High',
        team1: { name: 'Michigan State', logoId: teamLogoIds['Michigan State'], seed: 2, brand: 'Nike' },
        team2: { name: 'Bryant', logoId: teamLogoIds['Bryant'], seed: 15, brand: 'Wilson' }
      }
    ],
    East: [
      { 
        ...
        type: 'Total Bet', 
        confidence: 'High',
        team1: { name: 'UConn', logoId: teamLogoIds['UConn'], seed: 1, brand: 'Nike' },
        team2: { name: 'Norfolk State', logoId: teamLogoIds['Norfolk State'], seed: 16, brand: 'Nike' }
      },
      { 
        ...
        type: 'Total Bet', 
        confidence: 'High',
        team1: { name: 'Oklahoma', logoId: teamLogoIds['Oklahoma'], seed: 8, brand: 'Nike' },
        team2: { name: 'Florida', logoId: teamLogoIds['Florida'], seed: 9, brand: 'Nike' }
      },
      { 
        ...
        type: 'Upset Alert', 
        confidence: 'High',
        team1: { name: 'Memphis', logoId: teamLogoIds['Memphis'], seed: 5, brand: 'Nike' },
        team2: { name: 'Colorado State', logoId: teamLogoIds['Colorado State'], seed: 12, brand: 'Wilson' }
      },
      { 
        ...
        type: 'Favorite', 
        confidence: 'High',
        team1: { name: 'Maryland', logoId: teamLogoIds['Maryland'], seed: 4, brand: 'Wilson' },
        team2: { name: 'Grand Canyon', logoId: teamLogoIds['Grand Canyon'], seed: 13, brand: 'Nike' }
      },
      { 
        ...
        type: 'Upset Alert', 
        confidence: 'High',
        team1: { name: 'Missouri', logoId: teamLogoIds['Missouri'], seed: 6, brand: 'Nike' },
        team2: { name: 'Drake', logoId: teamLogoIds['Drake'], seed: 11, brand: 'Wilson' }
      },
      { 
        ...
        type: 'Total Bet', 
        confidence: 'High',
        team1: { name: 'Texas Tech', logoId: teamLogoIds['Texas Tech'], seed: 3, brand: 'Wilson' },
        team2: { name: 'UNC Wilmington', logoId: teamLogoIds['UNC Wilmington'], seed: 14, brand: 'Wilson' }
      },
      { 
        ...
        type: 'Favorite', 
        confidence: 'High',
        team1: { name: 'Kansas', logoId: teamLogoIds['Kansas'], seed: 7, brand: 'Wilson' },
        team2: { name: 'Arkansas', logoId: teamLogoIds['Arkansas'], seed: 10, brand: 'Nike' }
      },
      { 
        ...
        type: 'Upset Alert', 
        confidence: 'High',
        team1: { name: "St. John's", logoId: teamLogoIds["St. John's"], seed: 2, brand: 'Nike' },
        team2: { name: 'Omaha', logoId: teamLogoIds['Omaha'], seed: 15, brand: 'Wilson' }
      }
    ],
    West: [
      { game: 'Houston (1) vs. SIU Edwardsville (16)', balls: 'Nike vs. Wilson', recommendation: 'SIU Edwardsville', type: 'Upset Alert', confidence: 'High',
        team1: { name: 'Houston', logoId: teamLogoIds['Houston'], seed: 1, brand: 'Nike' },
        team2: { name: 'SIU Edwardsville', logoId: teamLogoIds['SIU Edwardsville'], seed: 16, brand: 'Wilson' }
      },
      { game: 'Gonzaga (8) vs. Georgia (9)', balls: 'Nike vs. Nike', recommendation: 'UNDER', type: 'Total Bet', confidence: 'High',
        team1: { name: 'Gonzaga', logoId: teamLogoIds['Gonzaga'], seed: 8, brand: 'Nike' },
        team2: { name: 'Georgia', logoId: teamLogoIds['Georgia'], seed: 9, brand: 'Nike' }
      },
      { game: 'Clemson (5) vs. McNeese (12)', balls: 'Nike vs. Wilson', recommendation: 'McNeese', type: 'Upset Alert', confidence: 'High',
        team1: { name: 'Clemson', logoId: teamLogoIds['Clemson'], seed: 5, brand: 'Nike' },
        team2: { name: 'McNeese', logoId: teamLogoIds['McNeese'], seed: 12, brand: 'Wilson' }
      },
      { game: 'Purdue (4) vs. High Point (13)', balls: 'Wilson vs. Spalding', recommendation: 'Purdue', type: 'Favorite', confidence: 'High',
        team1: { name: 'Purdue', logoId: teamLogoIds['Purdue'], seed: 4, brand: 'Wilson' },
        team2: { name: 'High Point', logoId: teamLogoIds['High Point'], seed: 13, brand: 'Spalding' }
      },
      { game: 'Illinois (6) vs. First Four Winner (11)', balls: 'Nike vs. TBD', recommendation: 'UNDER or TBD', type: 'Total Bet', confidence: 'Medium',
        team1: { name: 'Illinois', logoId: teamLogoIds['Illinois'], seed: 6, brand: 'Nike' },
        team2: { name: 'First Four Winner', logoId: teamLogoIds['First Four Winner'], seed: 11, brand: 'TBD' }
      },
      { game: 'Kentucky (3) vs. Troy (14)', balls: 'Nike vs. Wilson', recommendation: 'Troy', type: 'Upset Alert', confidence: 'High',
        team1: { name: 'Kentucky', logoId: teamLogoIds['Kentucky'], seed: 3, brand: 'Nike' },
        team2: { name: 'Troy', logoId: teamLogoIds['Troy'], seed: 14, brand: 'Wilson' }
      },
      { game: 'Utah State (7) vs. UCLA (10)', balls: 'Spalding vs. Wilson', recommendation: 'UCLA', type: 'Upset Alert', confidence: 'High',
        team1: { name: 'Utah State', logoId: teamLogoIds['Utah State'], seed: 7, brand: 'Spalding' },
        team2: { name: 'UCLA', logoId: teamLogoIds['UCLA'], seed: 10, brand: 'Wilson' }
      },
      { game: 'Tennessee (2) vs. Wofford (15)', balls: 'Nike vs. Wilson', recommendation: 'Wofford', type: 'Upset Alert', confidence: 'High',
        team1: { name: 'Tennessee', logoId: teamLogoIds['Tennessee'], seed: 2, brand: 'Nike' },
        team2: { name: 'Wofford', logoId: teamLogoIds['Wofford'], seed: 15, brand: 'Wilson' }
      }
    ],
    Midwest: [
      { game: 'Duke (1) vs. First Four Winner (16)', balls: 'Nike vs. TBD', recommendation: 'UNDER or TBD', type: 'Total Bet', confidence: 'Medium',
        team1: { name: 'Duke', logoId: teamLogoIds['Duke'], seed: 1, brand: 'Nike' },
        team2: { name: 'First Four Winner', logoId: teamLogoIds['First Four Winner'], seed: 16, brand: 'TBD' }
      },
      { game: 'Mississippi State (8) vs. Baylor (9)', balls: 'Wilson vs. Nike', recommendation: 'Mississippi State', type: 'Favorite', confidence: 'High',
        team1: { name: 'Mississippi State', logoId: teamLogoIds['Mississippi State'], seed: 8, brand: 'Wilson' },
        team2: { name: 'Baylor', logoId: teamLogoIds['Baylor'], seed: 9, brand: 'Nike' }
      },
      { game: 'Oregon (5) vs. Liberty (12)', balls: 'Nike vs. Nike', recommendation: 'UNDER', type: 'Total Bet', confidence: 'High',
        team1: { name: 'Oregon', logoId: teamLogoIds['Oregon'], seed: 5, brand: 'Nike' },
        team2: { name: 'Liberty', logoId: teamLogoIds['Liberty'], seed: 12, brand: 'Nike' }
      },
      { game: 'Arizona (4) vs. Akron (13)', balls: 'Nike vs. Nike', recommendation: 'UNDER', type: 'Total Bet', confidence: 'High',
        team1: { name: 'Arizona', logoId: teamLogoIds['Arizona'], seed: 4, brand: 'Nike' },
        team2: { name: 'Akron', logoId: teamLogoIds['Akron'], seed: 13, brand: 'Nike' }
      },
      { game: 'BYU (6) vs. VCU (11)', balls: 'Nike vs. Nike', recommendation: 'UNDER', type: 'Total Bet', confidence: 'High',
        team1: { name: 'BYU', logoId: teamLogoIds['BYU'], seed: 6, brand: 'Nike' },
        team2: { name: 'VCU', logoId: teamLogoIds['VCU'], seed: 11, brand: 'Nike' }
      },
      { game: 'Wisconsin (3) vs. Montana (14)', balls: 'Wilson vs. Wilson', recommendation: 'OVER', type: 'Total Bet', confidence: 'High',
        team1: { name: 'Wisconsin', logoId: teamLogoIds['Wisconsin'], seed: 3, brand: 'Wilson' },
        team2: { name: 'Montana', logoId: teamLogoIds['Montana'], seed: 14, brand: 'Wilson' }
      },
      { game: "Saint Mary's (7) vs. Vanderbilt (10)", balls: 'Wilson vs. Nike', recommendation: "Saint Mary's", type: 'Favorite', confidence: 'High',
        team1: { name: "Saint Mary's", logoId: teamLogoIds["Saint Mary's"], seed: 7, brand: 'Wilson' },
        team2: { name: 'Vanderbilt', logoId: teamLogoIds['Vanderbilt'], seed: 10, brand: 'Nike' }
      },
      { game: 'Alabama (2) vs. Robert Morris (15)', balls: 'Nike vs. Wilson', recommendation: 'Robert Morris', type: 'Upset Alert', confidence: 'High',
        team1: { name: 'Alabama', logoId: teamLogoIds['Alabama'], seed: 2, brand: 'Nike' },
        team2: { name: 'Robert Morris', logoId: teamLogoIds['Robert Morris'], seed: 15, brand: 'Wilson' }
      }
    ]
  };
                ...
                <td className="py-3 px-4">
                  <div className="flex items-center space-x-2">
                    <div className="flex flex-col items-center mr-3">
                      ...
                      />
                      <span className="text-xs text-gray-600">({game.team1.seed})</span>
                    </div>
                    <div className="flex flex-col flex-grow">
                      <div className="font-medium">{game.team1.name}</div>
                      <div className="text-xs text-gray-500">{game.team1.brand}</div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center space-x-2">
                    <div className="flex flex-col items-center mr-3">
                      <img 
                        ...
                        className="w-8 h-8 object-contain"
                      />
                      <span className="text-xs text-gray-600">({game.team2.seed})</span>
                    </div>
                    <div className="flex flex-col flex-grow">
                      <div className="font-medium">{game.team2.name}</div>
                      <div className="text-xs text-gray-500">{game.team2.brand}</div>
                    </div>
                  </div>
                </td>
                <td className="py-3 px-4">
                  <div className="flex flex-col">
                    <span className={`font-medium ${game.team1.brand === 'Wilson' ? 'text-green-600' : ''}`}>{game.team1.brand}</span>
                    <span className="text-xs my-1">vs</span>
                    <span className={`font-medium ${game.team2.brand === 'Wilson' ? 'text-green-600' : ''}`}>{game.team2.brand}</span>
                  </div>
                </td>
